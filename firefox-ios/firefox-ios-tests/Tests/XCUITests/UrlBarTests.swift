...
class UrlBarTests: BaseTestCase {
    ...
    func testSearchEngineLogo() {
        ...
        mozWaitForValueContains(app.textFields[AccessibilityIdentifiers.Browser.UrlBar.url], value: "google.com")
        ...
        typeSearchTermAndHitGo(searchTerm: "Firefox")
        // The search is conducted correctly trough the default search engine
        mozWaitForValueContains(app.textFields[AccessibilityIdentifiers.Browser.UrlBar.url], value: "bing.com")
    }
